...
<?php
$fetch_courses = mysqli_query($db,"SELECT * FROM advance_courses WHERE course_title LIKE '%$searchx%' && course_status='public' && application_status='approved' ORDER BY course_purchases DESC");
