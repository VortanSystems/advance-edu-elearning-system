...
<?php
$fetch_courses = mysqli_query($db,"SELECT * FROM advance_users WHERE fullname LIKE '%$searchw%' && profile_updated='yes' && access_level='user' ORDER BY user_purchases DESC ");
