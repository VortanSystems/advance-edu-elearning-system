		...
		<input type="checkbox" id="chk" aria-hidden="true">
			...
			<div class="signup">
				...
				<form action="" method="post">
					...
					<br>
					<center><a href="forgot_pass.php" style="text-decoration: none;color: white;">Forgot Password?<b style="color: yellow; text-decoration: underline;"> Reset Here </b></a></center>
					<br>
				</form>
			...
			<div class="login">
				...
				<form action="" method="post">
					...
					<input type="password" name="rest_key" placeholder="Your Reset Word" required="">
